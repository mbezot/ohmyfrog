    ...
    <div className="grid footer px10">
        ...
        <div className="colonne txtwhite m0">
            ...
            <h3>Suivre la grenouille</h3>
                <div className="footericontext">
                    <a href="https://fr.linkedin.com/in/melaniebezottrottet" target="_blank">
                    ...
                    <a href="https://www.instagram.com/frogposters/" target="_blank">
                        <svg width="20" height="20" fill="#ff6161" 
                    ...
                    <a href="https://www.facebook.com/frogposters" target="_blank">
                        <svg width="20" height="20" fill="#ff6161" 
                        viewBox="0 0 16 16">
